...
func (c *flexletServiceClient) CountPendingTasks(ctx context.Context, in *CountPendingTasksRequest, opts ...grpc.CallOption) (*CountPendingTasksResponse, error) {
	out := new(CountPendingTasksResponse)
	err := c.cc.Invoke(ctx, "/flex.FlexletService/CountPendingTasks", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _FlexletService_CountPendingTasks_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(CountPendingTasksRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(FlexletServiceServer).CountPendingTasks(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/flex.FlexletService/CountPendingTasks",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(FlexletServiceServer).CountPendingTasks(ctx, req.(*CountPendingTasksRequest))
	}
